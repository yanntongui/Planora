...
const SettingsModal: React.FC<{ isOpen: boolean; onClose: () => void }> = ({ isOpen, onClose }) => {
    ...
    return (
        <>
            ...
            />
            <MigrationModal isOpen={isMigrationOpen} onClose={() => setIsMigrationOpen(false)} />
                                        ...
                                        {activeTab === 'data' && (
                                            <div className="space-y-6">
                                                <div className="bg-blue-50 dark:bg-blue-900/10 p-4 rounded-lg flex items-start gap-3">
                                                    ...
                                                    <div>
                                                        <h4 className="text-sm font-bold text-blue-700 dark:text-blue-300">Data Synchronization</h4>
                                                        <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">
                                                            Your data is now synced with the cloud ({userName}). You can access it from any device.
                                                        </p>
                                                    </div>
                                                </div>
                                                <div>
                                                    ...
                                                    <div className="mt-3 grid gap-3">
                                                        <div className="flex flex-col gap-1">
                                                            <p className="text-xs text-zinc-500 dark:text-zinc-400">Migrate data from previous local version</p>
                                                            <button onClick={() => setIsMigrationOpen(true)} className="flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold bg-purple-600 text-white rounded-md hover:bg-purple-700 transition-colors">
